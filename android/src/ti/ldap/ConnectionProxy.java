...
public class ConnectionProxy extends KrollProxy
{
	...
	@Kroll.method
	public void connect(HashMap hm, @Kroll.argument(optional = true) KrollFunction success,
						@Kroll.argument(optional = true) KrollFunction error)
	{
	...
	@Kroll.method
	public RequestProxy simpleBind(HashMap hm, @Kroll.argument(optional = true) KrollFunction success,
								   @Kroll.argument(optional = true) KrollFunction error)
	{
	...
	@Kroll.method
	public RequestProxy saslBind(HashMap hm, @Kroll.argument(optional = true) KrollFunction success,
								 @Kroll.argument(optional = true) KrollFunction error)
	{
		// Create the request that implements the bind and handles the callbacks
	...
	@Kroll.method
	public SearchRequestProxy search(HashMap hm, @Kroll.argument(optional = true) KrollFunction success,
									 @Kroll.argument(optional = true) KrollFunction error)
	{
		// Create the request that implements the bind and handles the callbacks
