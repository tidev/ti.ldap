...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'..','assets','ti.ldap.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','TiLdapModuleAssets.m')
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','ti.ldap.js']
